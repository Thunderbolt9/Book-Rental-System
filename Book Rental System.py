...
'''
c1.bookrent("Gulliver's Travels", 3)
c1.pricebook("12,days", 3)
c1.bill("Shantanu Chhailkar", 9988217812, "sc@gmail.com")
for _ in range(0,5):
    print()
...
print("To return the book write command: <return_book>")
print("==============================================================")
print()
